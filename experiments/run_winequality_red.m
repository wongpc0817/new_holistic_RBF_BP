...
dataname = 'winequality-red';
layers = {[50]};
LRs = 10.^[-3];


datatable = readtable('data/winequality-red/winequality-red.csv','FileType','text');
datatable.quality = double(categorical(datatable.quality));
data = table2array(datatable);
label = data(:,end)';
data = data(:,1:end-1)';
save('data/winequality-red/data.mat',"data");
save('data/winequality-red/label.mat',"label");
